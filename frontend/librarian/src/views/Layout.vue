...
import { DashboardOutlined, FileTextOutlined, SearchOutlined, RollbackOutlined, DollarOutlined, LogoutOutlined, BellOutlined, MenuFoldOutlined, MenuUnfoldOutlined } from '@ant-design/icons-vue'
...
const titles = { overview: 'Dashboard', loans: 'Xử lý Phiếu mượn', search: 'Tra cứu Tình trạng', return: 'Xác nhận Trả sách', fines: 'Quản lý Phí phạt' }
const subs = { overview: 'Tổng quan hoạt động thư viện', loans: 'Duyệt hoặc từ chối yêu cầu mượn sách', search: 'Tìm kiếm theo mã thẻ độc giả', return: 'Wizard 3 bước xử lý trả sách', fines: 'Theo dõi và thu phí phạt' }
...
function doLogout() { localStorage.clear(); window.location.href = 'http://163.223.210.87:80/' }
</script>
